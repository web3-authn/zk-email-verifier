...
template RecoverEmailCircuit(max_header_bytes, max_body_bytes, n, k, pack_size) {
    ...
    // subject_start_idx: index of 'S' in "Subject: recover <...> ed25519:<...>"
    ...
    // "subject:recover " + accountId + " ed25519:" + publicKey
    ...
    subjectPrefix.out[15] === 32;  // space after "recover"

    // Sanity: account_id must start right after the fixed prefix
    subject_account_id_idx === subject_start_idx + prefix1_len;
